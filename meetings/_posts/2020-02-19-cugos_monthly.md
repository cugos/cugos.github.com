...
**[Peter Keum](https://pkgeo.com/)** will talk about [WA State Parcel Viewer](https://tileserver.pkgeo.com/webmap/#6/47.31/-121.2) using data from [WA GIS Portal](http://geo.wa.gov/). I'll talk about various open source tools (GDAL, QGIS, Tippecanoe etc..) to convert, assemble, create, and deploy this web app. I'll share the draft web map link at the meeting. (20 min)
