...
schedule:
  ...
  - type: Talk
    title: "DecLaRe DSS: An Open-Source Geospatial Platform for Agricultural Land Suitability Analysis"
    time: ~
    ...
    description: |
      DecLaRe stands for "Decision support for strengthening land resilience in the face of global challenges". This talk will explain the capabilities, technical set-up and approach of this open source-based <a href="https://declare.terragis.net/">DecLaRe Decision Support System</a> (DSS), which guides a constellation of agricultural professionals and researchers across Benin and Ghana. The DSS includes several specialized tools to calculate the local suitability of particular field crops and growing practices, as well as a micro nutrient chain tracker. This DSS is based on a TerraGIS project called "Base viewer" which supports a variety of web GIS projects.
...
<div class="spring-fling-announcement" style="font-size:1.2em; background:#f8e71c; color:#1a1a1a; padding: 1em; text-align:center;">
  <strong>🎉 CFP IS CURRENTLY OPEN! 🎉</strong><br>
